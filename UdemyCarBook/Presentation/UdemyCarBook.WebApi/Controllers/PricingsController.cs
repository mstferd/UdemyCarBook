...
namespace UdemyCarBook.WebApi.Controllers
{
    ...
    public class PricingsController : ControllerBase
    {
        ...
        //Pricing aracın kalktığı yer , teslim alıncağı yer gibi özellikler barındırır.
        ...
        [HttpPost]
        public async Task<IActionResult> CreatePricing(CreatePricingCommand command) // Tip eklendi
        {
